 ...
 */
public class WalkWayCountBaseAdapter extends BaseAdapter {
    private LayoutInflater layoutInflater;
    private Context context;
    private DailyStepRecord dailyStepRecord;
    private int position;
    private String TAG = WalkWayCountBaseAdapter.class.getSimpleName();
//    private LinearLayout linearLayout;
//    private String dateFormat;


    public WalkWayCountBaseAdapter(Context context, DailyStepRecord dailyStepRecord) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.walkway_count_item, null);
            viewTag = new ViewTag(
                    (TextView) convertView.findViewById(R.id.walkway_name),
        ...
        viewTag.name.setText(dailyStepRecord.getResult().get(position).getWalkwayName());
    ...
    class ViewTag {
        ...
        public ViewTag(TextView name, TextView date, TextView dailyCount, LinearLayout linearLayout) {
            this.name = name;
            this.date = date;
