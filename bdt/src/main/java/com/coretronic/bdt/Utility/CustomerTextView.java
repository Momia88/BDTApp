...
/**
 * Created by darren on 2014/12/29.
 */
public class CustomerTextView extends TextView{
    ...
    private float ellipsize;

    public CustomerTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        text = attrs.getAttributeValue(
                "http://schemas.android.com/apk/res/android", "text");
        textSize = attrs.getAttributeIntValue(namespace, "textSize", 50);//字体大小
        textColor = attrs.getAttributeIntValue(namespace, "textColor",Color.BLACK);//字体颜色
        paddingLeft = attrs.getAttributeIntValue(namespace, "paddingLeft", 5);
        paddingRight = attrs.getAttributeIntValue(namespace, "paddingRight", 5);
...
//        maxLines = attrs.getAttributeIntValue(namespace, "maxLines", 2);
    ...
    public CustomerTextView(Context context, float textSize, int textColor, float paddingLeft, float paddingRight, float marginLeft, float marginRight){
        super(context);
