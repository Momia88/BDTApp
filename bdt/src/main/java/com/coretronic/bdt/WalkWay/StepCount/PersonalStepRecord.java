 ...
 */
public class PersonalStepRecord extends Activity {
    private String TAG = PersonalStepRecord.class.getSimpleName();
    ...
    private PersonalStepRecordBaseAdapter listAdapter = null;
    ...
    public JsonHttpResponseHandler jsonHandler = new JsonHttpResponseHandler() {
        ...
        public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
            ...
            if (dailyStepRecord.getMsgCode().equals(AppConfig.SUCCESS_CODE)) {
                ...
                listView.setAdapter(new PersonalStepRecordBaseAdapter(mContext, dailyStepRecord));
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        barTitle.setText("計步記錄");
        sharedPreferences = getSharedPreferences(AppConfig.SHAREDPREFERENCES_NAME, 0);
        final String url = AppConfig.DOMAIN_SITE_PATE + AppConfig.REQUEST_DAILY_WALK_COUNT;
