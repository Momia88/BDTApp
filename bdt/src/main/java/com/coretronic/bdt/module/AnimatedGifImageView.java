...
/**
 * Created by darren on 2014/8/28.
 */
...
public class AnimatedGifImageView extends ImageView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (mMovie != null) {
            Log.i("info", "mMovie.width()/mMovie.height():" + mMovie.width() + "/" + mMovie.height());

            Log.i("info", "widthMeasureSpec/heightMeasureSpec:" + widthMeasureSpec + "/" + heightMeasureSpec);
            ...
            Log.i("info", "measureModeWidth:" + measureModeWidth );

            float scaleW = 1f, scaleH = 1f;
            if (measureModeWidth != MeasureSpec.UNSPECIFIED) {

                Log.i("info", "measureModeWidth != MeasureSpec.UNSPECIFIED");
                int maximumWidth = MeasureSpec.getSize(widthMeasureSpec);
                if (movieWidth > maximumWidth) {
                    scaleW = (float) movieWidth / (float) maximumWidth;
                    Log.i("info","movieWidth > maximumWidth mScaleW:"+mScaleW);
                } else {
                    scaleW = (float) maximumWidth / (float) movieWidth;
                    Log.i("info","movieWidth <= maximumWidth mScaleW:"+mScaleW);
                }
                Log.i("info", "maximumWidth:"+maximumWidth);
            }
            ...
            if (measureModeHeight != MeasureSpec.UNSPECIFIED) {
                Log.i("info", "measureModeHeight != MeasureSpec.UNSPECIFIED");
            ...
            switch (mType) {
                case FIT_CENTER:
                    Log.i("info","case FIT_CENTER mScaleW/scaleH:"+mScaleW+"/"+scaleH);
            ...
            Log.i("info","measureModeHeight:"+measureModeHeight);
            Log.i("info","measureModeWidth:"+measureModeWidth);

            Log.i("info","mScaleW:"+mScaleW);
            Log.i("info","mScaleH:"+mScaleH);
